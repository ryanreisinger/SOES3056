...
2. Lesson 04 Data Structures <https://swcarpentry.github.io/r-novice-gapminder/04-data-structurespart1/index.html>
...
## Resources
A useful resource, for this week and in general, is the free, open-source book [R for Data Science](https://r4ds.had.co.nz/) by [Hadley Wickham](https://hadley.nz/) (chief scientist at RStudio) and Garrett Grolemund. We'll dip into one of the chapters of the book this week. Be aware that the examples in the book use packages from the ['tidyverse'](https://www.tidyverse.org/), which has slightly different syntax for doing things compared to 'base' R (that is, the 'vanilla' R you're probably used to at the moment). We'll also use two lessons from Software Carpentry again.
...
#|   by communicating your results to other humans". From https://r4ds.had.co.nz/explore-intro.html.
#| fig-alt: >
...
#| out.width: NULL
knitr::include_graphics("resources/base.png", dpi = 270)
```
...
1. Lesson 05: Exploring Data Frames <https://swcarpentry.github.io/r-novice-gapminder/05-data-structures-part2/index.html>.
2. Lesson 06: Subsetting Data <https://swcarpentry.github.io/r-novice-gapminder/06-data-subsetting/index.html>
...
Let's work through Wickham and Grolemund's book chapter on Workflow and projects (Chapter 8) together:
